...
class CustomColumnMainAxisAlignmentWidget extends StatefulWidget {
  const CustomColumnMainAxisAlignmentWidget({
    super.key,
  });

  @override
  State<CustomColumnMainAxisAlignmentWidget> createState() => _CustomColumnMainAxisAlignmentWidgetState();
}

class _CustomColumnMainAxisAlignmentWidgetState extends State<CustomColumnMainAxisAlignmentWidget> {
  @override
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          icon: SvgPicture.asset(
              ...
              color: Colors.white),
          value: customEditPortalProvider.selectedColumnAlignment,
          items: customEditPortalProvider.mainAxisAlignments
          ...
          onChanged: (newValue) {
            customEditPortalProvider.setSelectedColumnAlignment(newValue!);
