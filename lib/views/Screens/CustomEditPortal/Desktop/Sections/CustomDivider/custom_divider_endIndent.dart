...
class CustomDividerEndIndentWidget extends StatefulWidget {
  const CustomDividerEndIndentWidget({
    super.key,
  });

  @override
  State<CustomDividerEndIndentWidget> createState() =>
      _CustomDividerEndIndentWidgetState();
}

class _CustomDividerEndIndentWidgetState
    extends State<CustomDividerEndIndentWidget> {
  ...
  void handleDividerEndIndentChanged(int value) {
    setState(() {
            ...
            child: TextField(
              ...
              onSubmitted: (value) {
                ...
                if (spacingValue != null) {
                  handleDividerEndIndentChanged(spacingValue);
                }
              },
            ),
          ),
