...
class CustomDividerIndentWidget extends StatefulWidget {
  const CustomDividerIndentWidget({
    super.key,
  });

  @override
  State<CustomDividerIndentWidget> createState() =>
      _CustomDividerIndentWidgetState();
}

class _CustomDividerIndentWidgetState
    extends State<CustomDividerIndentWidget> {
  ...
  void handleDividerIndentChanged(int value) {
    setState(() {
            ...
            child: TextField(
              ...
              onSubmitted: (value) {
                ...
                if (spacingValue != null) {
                  handleDividerIndentChanged(spacingValue);
                }
              },
            ),
          ),
