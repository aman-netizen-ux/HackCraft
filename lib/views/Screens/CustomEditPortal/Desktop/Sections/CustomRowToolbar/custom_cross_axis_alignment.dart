...
class CustomCrossAxisAlignmentWidget extends StatefulWidget {
  const CustomCrossAxisAlignmentWidget({
    super.key,
  });

  @override
  State<CustomCrossAxisAlignmentWidget> createState() => _CustomCrossAxisAlignmentWidgetState();
}

class _CustomCrossAxisAlignmentWidgetState extends State<CustomCrossAxisAlignmentWidget> {
  @override
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          icon: SvgPicture.asset(
              ...
              color: Colors.white),
          value: customEditPortalProvider.selectedRowCrossAlignment,
          ...
          onChanged: (newValue) {
            customEditPortalProvider.setSelectedRowCrossAlignment(newValue!);
