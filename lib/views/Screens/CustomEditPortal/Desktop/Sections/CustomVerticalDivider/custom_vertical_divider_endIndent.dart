...
class CustomVerticalDividerEndIndentWidget extends StatefulWidget {
  const CustomVerticalDividerEndIndentWidget({
    super.key,
  });

  @override
  State<CustomVerticalDividerEndIndentWidget> createState() =>
      _CustomVerticalDividerEndIndentWidgetState();
}

class _CustomVerticalDividerEndIndentWidgetState
    extends State<CustomVerticalDividerEndIndentWidget> {
  late TextEditingController endIndentController;

  @override
  void initState() {
    super.initState();
    endIndentController = TextEditingController();
  }

  @override
  void dispose() {
    endIndentController.dispose();
    super.dispose();
  }

  void handleVerticalDividerEndIndentChanged(int value) {
    setState(() {
      endIndentController.text = value.toString();
    });
  ...
  Widget build(BuildContext context) {
    ...
    if (customEditPortalProvider.selectedWidgetKey != null) {
      int currentSpacing = customEditPortalProvider.getPropertyValue(
          ...
          customEditPortalProvider.selectedWidgetKey.toString(),
          "endIndent");
      endIndentController.text = currentSpacing.toString();
    }
    return Tooltip(
      message: "End Indent",
      verticalOffset: 5,
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: const Icon(Icons.format_indent_decrease, color: Colors.white),
          ),
          Container(
            height: scaleHeight(context, 37),
            ...
            child: TextField(
              ...
              onSubmitted: (value) {
                ...
                if (spacingValue != null) {
                  handleVerticalDividerEndIndentChanged(spacingValue);
                }
              },
            ),
          ),
