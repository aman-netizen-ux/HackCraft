...
class CustomVerticalDividerIndentWidget extends StatefulWidget {
  const CustomVerticalDividerIndentWidget({
    super.key,
  });

  @override
  State<CustomVerticalDividerIndentWidget> createState() =>
      _CustomVerticalDividerIndentWidgetState();
}

class _CustomVerticalDividerIndentWidgetState
    extends State<CustomVerticalDividerIndentWidget> {
  late TextEditingController indentController;

  @override
  void initState() {
    super.initState();
    indentController = TextEditingController();
  }
  ...
  void handleVerticalDividerIndentChanged(int value) {
    setState(() {
      indentController.text = value.toString();
    });
  ...
  Widget build(BuildContext context) {
    ...
    if (customEditPortalProvider.selectedWidgetKey != null) {
      int currentSpacing = customEditPortalProvider.getPropertyValue(
          ...
          customEditPortalProvider.selectedWidgetKey.toString(),
          "indent");
      indentController.text = currentSpacing.toString();
    }
    return Tooltip(
            ...
            child: TextField(
              ...
              onSubmitted: (value) {
                ...
                if (spacingValue != null) {
                  handleVerticalDividerIndentChanged(spacingValue);
                }
              },
            ),
          ),
