...
class CustomVerticalDividerThicknessWidget extends StatefulWidget {
  const CustomVerticalDividerThicknessWidget({
    super.key,
  });

  @override
  State<CustomVerticalDividerThicknessWidget> createState() =>
      _CustomVerticalDividerThicknessWidgetState();
}

class _CustomVerticalDividerThicknessWidgetState
    extends State<CustomVerticalDividerThicknessWidget> {
  ...
  void handleVerticalDividerThicknessChanged(int value) {
    setState(() {
            ...
            child: TextField(
              ...
              onSubmitted: (value) {
                ...
                if (spacingValue != null) {
                  handleVerticalDividerThicknessChanged(spacingValue);
                }
              },
            ),
          ),
