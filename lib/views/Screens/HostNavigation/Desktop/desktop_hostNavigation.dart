    ...
    return Stack(
      children: [
        ...
        Column(
          ...
          Expanded(
              child: _widgetOptions.elementAt(hostNavigationProvider.currentIndex),
            )
          ],
        ),
      ],
...
class HostNavTab extends StatelessWidget {
  const HostNavTab({
    super.key,
    required this.hostNavigationProvider, this.onTap, required this.tabIndex, required this.title,
  });
