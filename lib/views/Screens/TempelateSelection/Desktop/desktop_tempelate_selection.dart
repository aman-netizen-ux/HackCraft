    ...
    color: Colors.black.withOpacity(0.3),
        ...
        Stack(
          ...
          Positioned(
            ...
            left: (scaleWidth(context, 1280)-scaleWidth(context, 855))/2,
            child: Row(
              ...
              children: [
                templateCard(
                  ...
                  subtitle: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut ante eu nisi imperdiet ullamcorper. Sed nec ante ac lorem eleifend viverra',
                  subTitleColor: black1,
                  borderColor: defaultTemplateCardBorder
                ),

                SizedBox(width: scaleWidth(context, 69),),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            Padding(
              padding:  EdgeInsets.symmetric(horizontal: scaleWidth(context, 20)), // changed from 11 to 20
              child: ClipRRect(
             ...
             Text(title,
                 ...
                 SizedBox(height: scaleHeight(context, 19),),
